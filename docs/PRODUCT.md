...
Ascii Video is a focused, shareable agent workflow.

## What it does

Convert video or audio into colored ASCII MP4 or GIF output. Use when the user explicitly requests this capability or a closely related task.

...
- **Frame and beat sampler**
- **Color glyph renderer**
- **FFmpeg encoder**
- **MP4 or GIF**
...
This repository now includes a typed, task-adaptive harness contract for **Ascii Video**. The contract maps the skill to memory, planning, capability-orchestration, and action modules; defines bounded repair and stop behavior; and records skill-specific verification evidence.
